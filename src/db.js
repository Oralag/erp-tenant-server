...
async function initDb() {
  ...
  try {
    await client.query(`
      ...
      CREATE TABLE IF NOT EXISTS stock_allocation (id SERIAL PRIMARY KEY, transfer_no VARCHAR(100) DEFAULT '', goods_name VARCHAR(200) DEFAULT '', num DECIMAL(10,4) DEFAULT 0, from_warehouse VARCHAR(100) DEFAULT '', to_warehouse VARCHAR(100) DEFAULT '', remark TEXT DEFAULT '', status INT DEFAULT 0, created_at TIMESTAMP DEFAULT NOW());
