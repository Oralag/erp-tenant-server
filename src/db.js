...
async function initDb() {
  ...
  try {
    await client.query(`
      ...
      CREATE TABLE IF NOT EXISTS warehouses (id SERIAL PRIMARY KEY, name VARCHAR(100) NOT NULL, address TEXT DEFAULT '', remark TEXT DEFAULT '', status INT DEFAULT 1, create_time TIMESTAMP DEFAULT NOW());
